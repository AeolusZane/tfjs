/**
 * 1.tf.tidy 消除中间变量 训练更快
 * 2.tf.concat 数据合并 数组变纯tenfors
 * 3.tf.util.shuffle 洗牌算法
 * 4.tf.tensor2d 转换为二维数组 并且指定数组的大小
 * 5.tf.oneHot 转换为one-hot编码 {0, 1, 2} into one-hot encoding (.e.g., 0 --> [1, 0, 0]).
 * 6.xs.slice 切割tensorflow数据
 */
/**
 * @license
